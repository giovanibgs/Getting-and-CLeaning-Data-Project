...
x_train <- read.table("C:/Users/usuario/Desktop/DSSWork/UCI HAR Dataset/train/X_train.txt", header = FALSE)
X_test <- read.table("C:/Users/usuario/Desktop/DSSWork/UCI HAR Dataset/test/X_test.txt", header = FALSE)
y_train <- read.table("C:/Users/usuario/Desktop/DSSWork/UCI HAR Dataset/train/y_train.txt", header = FALSE)
y_test <- read.table("C:/Users/usuario/Desktop/DSSWork/UCI HAR Dataset/test/y_test.txt", header = FALSE)
subject_train <- read.table("C:/Users/usuario/Desktop/DSSWork/UCI HAR Dataset/train/subject_train.txt", header = FALSE)
subject_test <- read.table("C:/Users/usuario/Desktop/DSSWork/UCI HAR Dataset/test/subject_test.txt", header = FALSE)
...
activities <- read.table("C:/Users/usuario/Desktop/DSSWork/UCI HAR Dataset/activity_labels.txt")
...
write.table(tidyDataAVGSet, "tidyDataFileAVG.txt", row.names = FALSE)